/****************************************************************************
** Meta object code from reading C++ file 'deletefrdb.h'
**
...
#error "The header file 'deletefrdb.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(2, 33, 0) // ""
    ...
    "deletefrdb\0on_pushButton_clicked\0"
};
...
void deletefrdb::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        deletefrdb *_t = static_cast<deletefrdb *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
